...
class SoftMaxRegression:
    ...
    def fit(self, train_data, train_label):
        ...
        self.__coef = gr.gradient_descent(self.__gradient_log_likelihood, coef_shape=(classes, features))
    ...
    def predict(self, test_data):
        predicted_label = [np.argmax(self.__softmax(np.matmul(self.__coef, test_data[i]))) + 1
